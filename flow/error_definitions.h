...
ERROR( snap_disable_tlog_pop_failed,  2500, "Failed to disable popping of mutations from TLogs")
...
ERROR( snap_enable_tlog_pop_failed,  2504, "Failed to enable popping of mutations from TLogs")
...
ERROR( snap_across_recovery_unsupported, 2508, "Failed because of cluster recovery")
